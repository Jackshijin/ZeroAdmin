 ...
 * @Description: 弹幕
 * @Author: shrijin
 * @Date: 2023-07-18 14:12:38
 * @LastEditors: shrijin
 * @LastEditTime: 2023-07-18 16:43:31
-->
...
function channelsChange(val: number) {
  ...
  <el-card shadow="never">
    ...
    <div class="flex gap-5">
      ...
      <div class="main">
        ...
        <p>
          模式:
          <el-button @click="switchSlot(true)">弹幕slot</el-button>
          <el-button @click="switchSlot(false)">普通文本</el-button>
        </p>
        <p>
          速度：
          <el-button @click="speedsChange(-10)">减速</el-button>
          <el-button @click="speedsChange(10)">加速</el-button>
        ...
        <p>
          轨道：
          <el-button @click="channelsChange(-1)">-1</el-button>
          <el-button @click="channelsChange(1)">+1</el-button>
          <el-button @click="channelsChange(-config.channels)">填满</el-button>
          <span class="ml-5">当前轨道：{{ config.channels }}像素/s</span>
        </p>
        <p class="flex">
          <el-input
            type="text"
